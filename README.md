...
<script>
    ...
    const QUESTIONS = [
        ...
        { text: "مدة الإشعار في الاستقالة للعقد غير محدد المدة هي 30 يوم", options: ["صح", "خطأ"], correct: 1 },   // خطأ (تم التصحيح)
        { text: "يظل العقد ساري  خلال فترة طلب الإستقالة", options: ["صح", "خطأ"], correct: 0 },   // صح
